...
import { ActiveAlertIcon } from '../../../icons/icons';
...
function createData(smbId, stringId, alertName, SeverityLevel, TimeDetected, ActionRequired) {
  return { smbId, stringId, alertName, SeverityLevel, TimeDetected, ActionRequired };
}

function generateActiveAlertsData(smbId, panelCount) {
  ...
  for (let i = 1; i <= panelCount; i++) {
    ...
    rows.push(createData(smbId, stringId, alertName, SeverityLevel, TimeDetected, ActionRequired));
  }
  return rows;
}

const rows = [
  ...generateActiveAlertsData('SMB001', 32),
  ...generateActiveAlertsData('SMB002', 25),
